...
class pelatihan_model extends ci_model
{
  ...
  function data()
  {
    ...
    return $query = $this->db->get('pelatihan');
  }

  public function dataJoin()
  {
    $this->db->select('*');
    $this->db->from('pelatihan as p');
  ...
  //==========IJAZAH============
  public function ambil_data_pelatihan($id)
  {
    $this->db->select('*');
  ...
  public function ambil_detail_pelatihan($nomor)
  {
    $this->db->select('*');
    $this->db->from('pelatihan');
    $this->db->where('id_pelatihan', $nomor);

    $query = $this->db->get();
    return $query;
  }
  public function tambah_data_pelatihan($data, $table)
  {
    $this->db->insert($table, $data);
  }
  public function ubah_data_pelatihan($where, $data, $table)
  {
    $this->db->where($where);
    $this->db->update($table, $data);
  ...
  public function hapus_data_pelatihan($where, $table)
  {
    $this->db->where($where);
    $this->db->delete($table);
