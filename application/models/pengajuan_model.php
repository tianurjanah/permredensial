...
class pengajuan_model extends ci_model{
    ...
    public function dataJoin($nama)
    {
      $this->db->select('pengajuan_index.id,pengajuan_index.id_user, user.nama, pengajuan_index.nama_mitra, pengajuan_index.tanggal_pengajuan');
      $this->db->from('pengajuan_index');
      $this->db->join('user', 'pengajuan_index.id_user = user.id_user');
      $this->db->where('nama_mitra',$nama);
      
      $this->db->order_by('pengajuan_index.id','ASC');
