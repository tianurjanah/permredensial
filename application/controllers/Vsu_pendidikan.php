...
class Vsu_pendidikan extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('vsu_pendidikan_model');

    }

    public function index()
    {
        $data['title'] = 'VERIFIKASI PENDIDIKAN';
        $id = $this->session->userdata('login_session')['id_user'];
        $data['vsu_pendidikan'] = $this->vsu_pendidikan_model->data($id)->result();
