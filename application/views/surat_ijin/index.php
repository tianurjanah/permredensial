...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url() ?>SuratIzin/tambah_surat_izin" class="btn btn-sm btn-primary btn-icon-split">
            <span class="text text-white">Tambah Surat Izin</span>
                        ...
                        <tbody style="cursor:pointer;" id="tbody">
                            ...
                            foreach ($surat_ijin as $si): ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>SuratIzin/ubah_surat_izin/<?= $si->nomor_izin ?>"
                                                class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="<?= base_url() ?>SuratIzin/proses_hapus_surat_izin/<?= $si->nomor_izin ?>"
