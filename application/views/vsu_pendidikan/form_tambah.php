...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>Vsu_pendidikan/proses_tambah_pendidikan" name="myForm" method="POST"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                <a href="<?= base_url() ?>vsu_pendidikan/index" class="btn btn-md btn-circle btn-info">
                    <i class="fas fa-arrow-left"></i>
                </a>
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Tambah Data VSU Pendidikan</h1>
            </div>
        </div>
                            ...
                            <div class="form-group">
                                <div class="form-group"><label>Surat Balasan</label>
                                    ...
                                    <center>
                                        <div>
                                            <br>
                                            <img src="<?= base_url() ?>assets/upload/berkas_vsu_pendidikan/cloud.png"
