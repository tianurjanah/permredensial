                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="dtHorizontalExample" width="100%" cellspacing="0">
                        ...
                        <tbody style="cursor:pointer;" id="tbody">
                            ...
                            foreach ($berita as $i): ?>
                            <tr>
                                <td onclick="detail('<?= $i->id_berita ?>')"><?= $i->id_berita ?></td>
                                <td onclick="detail('<?= $i->id_berita ?>')"><?= $i->nama ?></td>
                                <td onclick="detail('<?= $i->id_berita ?>')"><?= $i->mitra ?></td>
                                <td onclick="detail('<?= $i->id_berita ?>')"><?= $i->komite ?></td>
                                <td onclick="detail('<?= $i->id_berita ?>')"><?= $i->tanggal ?></td>
                                <td onclick="detail('<?= $i->id_berita ?>')"><?= $i->status ?></td>

                                <td>
                                    <center>
                                        <a href="<?= base_url() ?>berita_acara/cetak_acara/<?= $i->id_berita ?>"
