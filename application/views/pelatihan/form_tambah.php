...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>Pelatihan/proses_tambah_pelatihan" name="myForm" method="POST"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                ...
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Tambah Data Pelatihan</h1>
            </div>

            <button type="submit" class="btn btn-primary btn-md btn-icon-split">
                <span class="text text-white">Simpan Data Pelatihan</span>
            ...
            <div class="col-lg-8 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-info">
                        <h6 class="m-0 font-weight-bold text-white">Form Data Pelatihan Kerja</h6>
                    </div>
                    <div class="card-body">
                        <div class="col-lg-12">
                            <!-- Nomor Surat -->
                            <div class="form-group"><label>ID Pelatihan</label>
                                <input class="form-control" name="id_pelatihan" type="text" placeholder="">
                            </div>
                            <!-- Nomor Surat -->
                            <div class="form-group"><label>Nama Pelatihan</label>
                                <input class="form-control" name="nama_pelatihan" type="text" placeholder="">
                            </div>
                            <!-- Nomor Surat -->
                            <div class="form-group"><label>Masa Berlaku Sertifikat</label>
                                <input class="form-control" name="berlaku" type="date" placeholder="">
                            </div>
                            <!-- Nomor Surat -->
                            <div class="form-group"><label>Penyelenggara</label>
                                <input class="form-control" name="penyelenggara" type="text" placeholder="">
                            </div>
