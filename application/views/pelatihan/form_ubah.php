...
<div class="container-fluid">
    ...
    <?php foreach ($pelatihan as $p): ?>
        ...
        <form action="<?= base_url() ?>Pelatihan/proses_ubah_pelatihan/<?= $p->id_pelatihan ?>" name="myForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group"><label>Masa Berlaku</label>
                                    <input class="form-control" name="berlaku" type="date"
                                        value="<?= $p->berlaku ?>">
                                </div>
