...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>Vsu_suratizin/proses_ubah_suratizin" name="myForm" method="POST"
        enctype="multipart/form-data" onsubmit="return validateForm()">
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                <a href="<?= base_url() ?>Vsu_suratizin/index" class="btn btn-md btn-circle btn-info">
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Nomor Izin VSU</label>
                                <input class="form-control" name="suratizin" id="id" type="text" placeholder=""
                                    value="<?= $vs->nomor_izinvsu ?>" readonly="">
                            </div>

                            <!-- Perusahaan -->
                            <div class="form-group"><label>Nama Institusi</label>
                                <input class="form-control" name="institusi" id="institusi" type="text" placeholder=""
                                    value="<?= $vs->nama_institusi ?>">
                            </div>
                            ...
                            <div class="form-group"><label>Surat Balasan</label>
                                ...
                                <div class="pdf-container">
                                    <?php if ($vs->balasan != ''): ?>
                                    <embed src="<?= base_url() ?>assets/upload/berkas_vsu_suratizin/<?= $vs->balasan ?>"
        ...
        <div class="text-right">
            <button type="submit" class="btn btn-success btn-md btn-icon-split">
                <span class="text text-white">Ubah Data VSU Surat Izin</span>
