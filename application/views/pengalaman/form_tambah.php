...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>pengalaman/proses_tambah_pendidikan" name="myForm" method="POST"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                ...
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Tambah Data Pengalaman Kerja</h1>
            </div>
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Nama Perusahaan</label>
                                <input class="form-control" name="perusahaan" id="perusahaan" type="text"
                                    placeholder="">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group"><label>Surat Referensi</label>
                                    ...
                                    <center>
                                        <div>
                                            <br>
                                            <img src="<?= base_url() ?>assets/upload/berkas_pengalaman/cloud.png"
