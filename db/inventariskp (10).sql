...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jun 2023 pada 12.09
...
('BA-0003', 'KOMP-0001', 'USR-004', 'Hizkia', 'Mitraaa', 'komite terapi naon', '2023-06-11', 'Minggu', 'DITOLAK (lihat bawah)');
...
CREATE TABLE `pengajuan` (
  ...
  `id_pengajuan_index` varchar(50) NOT NULL,
  `id_nakes` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `id_kompetensi` int(10) NOT NULL,
  `status` enum('Diminta','Mandiri','Supervisi','Tidak Disetujui') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Struktur dari tabel `pengajuan_index`
--
...
--
-- Dumping data untuk tabel `pengajuan_index`
--

INSERT INTO `pengajuan_index` (`id`, `id_user`, `mitra`, `tgl_pengajuan`, `kategori`, `status`, `catatan`, `jadwal`, `pukul`) VALUES
('KOMP-0001', 'USR-004', 'Mitraaa', '2023-06-05 20:51:42', 'Proses Kredensial Ulang', 'Approve', 'INI Catatan', '2023-06-07', '15:19:00');
...
INSERT INTO `rekomendasi` (`id_rekomendasi`, `id_pengajuan_index`, `id_user`, `mitra`, `komite`, `status`, `komentar`, `tanggal`) VALUES
('SR-0001', 'KOMP-0001', 'USR-004', 'Mitraaa', 'komite terapi naon', 'DISETUJUI dengan modifikasi (lihat bawah)', 'INI Catatan Hayuuk', '2023-06-11');

-- --------------------------------------------------------

--
-- Struktur dari tabel `sehat`
--
...
--
-- Dumping data untuk tabel `sehat`
--
...
CREATE TABLE `surat_penugasan` (
  ...
  `nip_direktur` varchar(20) NOT NULL,
...
INSERT INTO `surat_penugasan` (`id_penugasan`, `id_user`, `tanggal_penugasan`, `tanggal_berlaku`, `direktur`, `nip_direktur`, `nip`) VALUES
('001/SPKK/06/2023', 'USR-004', '2023-06-11', '2026-06-11', 'Kim Jong Unc', '', ''),
('2024/SPKK/06/2023', 'USR-004', '2023-06-11', '2026-06-11', 'Kim Jong Unc', '554446', '444449999');
...
('USR-004', '444449999', 'Hizkia', 'hizkia', 'hizkia@gmail.com', '08072001', 'Pegawai', '4ba91aaa0d88b0c3200b9e20eb856c22', '', '0000-00-00', '', '', '', '', '0000-00-00', 'person.png', 'Aktif'),
...
('USR-009', '554446', 'Kim Jong Unc', 'kim', 'kim@gmail.com', '086235465236', 'Direktur', '98467a817e2ff8c8377c1bf085da7138', '', '0000-00-00', '', '', '', '', '0000-00-00', 'travel.jpg', 'Aktif');

-- --------------------------------------------------------

--
-- Struktur dari tabel `vsu_pendidikan`
--
...
--
-- Struktur dari tabel `vsu_pengalaman`
--
...
--
-- Dumping data untuk tabel `vsu_pengalaman`
--
...
--
-- Struktur dari tabel `vsu_suratizin`
--
...
--
-- Dumping data untuk tabel `vsu_suratizin`
--
...
--
-- Indeks untuk tabel `pengajuan_index`
--
...
ALTER TABLE `surat_penugasan`
  ...
  ADD KEY `idx_surat_penugasan_user` (`id_user`);
...
--
-- Indeks untuk tabel `vsu_pendidikan`
--
...
--
-- Indeks untuk tabel `vsu_pengalaman`
--
...
--
-- Indeks untuk tabel `vsu_suratizin`
--
...
--
-- Ketidakleluasaan untuk tabel `pengajuan_index`
--
ALTER TABLE `pengajuan_index`
  ADD CONSTRAINT `idx_user_pengajuan_index` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `surat_penugasan`
--
ALTER TABLE `surat_penugasan`
  ADD CONSTRAINT `idx_surat_penugasan_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
