...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2023 at 04:41 AM
...
CREATE TABLE `vsu_pendidikan` (
  `nomor_pendidikanvsu` int(50) NOT NULL,
  `id_user` varchar(50) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `vsu_pengalaman` (
  `nomor_pengalamanvsu` int(50) NOT NULL,
  `id_user` varchar(50) CHARACTER SET utf8 NOT NULL,
...
--
ALTER TABLE `surat_ijin`
  MODIFY `nomor_ijin` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vsu_pendidikan`
--
ALTER TABLE `vsu_pendidikan`
  MODIFY `nomor_pendidikanvsu` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vsu_suratizin`
--
ALTER TABLE `vsu_suratizin`
  MODIFY `nomor_izinvsu` int(50) NOT NULL AUTO_INCREMENT;
