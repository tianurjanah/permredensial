...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jun 2023 pada 10.38
...
CREATE TABLE `pengajuan_index` (
  ...
  `status` enum('Diminta','Disetujui','Ditolak') NOT NULL,
  `catatan` text NOT NULL,
...
('KOMP-0001', 'USR-004', '', '2023-06-05 20:51:42', 'Proses Kredensial Ulang', 'Ditolak', 'asfafasfasfasf', '2023-06-07', '15:19:00');
